...
func RegisterFileHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FileClient) error {
	...
	mux.Handle("GET", pattern_File_File_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/core.backend.integration.api.v1.file.File/File", runtime.WithHTTPPathPattern("/v1/file/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_File_File_0(rctx, inboundMarshaler, client, req, pathParams)
