...
type BotClient interface {
	// Send bot command
	SendCommand(ctx context.Context, in *SendCommandModel, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *botClient) SendCommand(ctx context.Context, in *SendCommandModel, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type BotServer interface {
	// Send bot command
	SendCommand(context.Context, *SendCommandModel) (*emptypb.Empty, error)
...
func (UnimplementedBotServer) SendCommand(context.Context, *SendCommandModel) (*emptypb.Empty, error) {
...
func _Bot_SendCommand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BotServer).SendCommand(ctx, req.(*SendCommandModel))
	}
